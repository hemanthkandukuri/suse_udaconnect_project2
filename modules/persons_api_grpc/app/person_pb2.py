...
_LISTOFPERSONMESSAGES = _descriptor.Descriptor(
  name='ListOfPersonMessages',
  full_name='ListOfPersonMessages',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='persons_list', full_name='ListOfPersonMessages.persons_list', index=0,
...
_LISTOFPERSONMESSAGES.fields_by_name['persons_list'].message_type = _PERSONMESSAGE
DESCRIPTOR.message_types_by_name['PersonMessage'] = _PERSONMESSAGE
DESCRIPTOR.message_types_by_name['Empty'] = _EMPTY
DESCRIPTOR.message_types_by_name['ListOfPersonMessages'] = _LISTOFPERSONMESSAGES
...
ListOfPersonMessages = _reflection.GeneratedProtocolMessageType('ListOfPersonMessages', (_message.Message,), {
  'DESCRIPTOR' : _LISTOFPERSONMESSAGES,
  '__module__' : 'person_pb2'
  # @@protoc_insertion_point(class_scope:ListOfPersonMessages)
  })
_sym_db.RegisterMessage(ListOfPersonMessages)
...
_PERSONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=_EMPTY,
    output_type=_LISTOFPERSONMESSAGES,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
