...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                ...
                response_deserializer=person__pb2.ListOfPersonMessages.FromString,
                )
...
def add_PersonServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=person__pb2.ListOfPersonMessages.SerializeToString,
            ),
...
class PersonService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/PersonService/Get',
            ...
            person__pb2.ListOfPersonMessages.FromString,
